                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/dropshipping/request/withdrawallist">Back to List</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                                                    ...
                                                    <div class="tab-pane fade active show" id="custom-tabs-three-home"
                                                        ...
                                                        <div class="row mb-3 required">
                                                            <label for="input-name-1"
                                                                class="col-sm-2 col-form-label required-label">Payable Amount</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" name="name" placeholder="Name"
                                                                    v-model="request.payable_amount" disabled readonly
                                                                    class="form-control" />
                                                            </div>
                                                        </div>
...
const saveData = () => {
    ...
    axios.post('/deposit/updateWithDrawRequest', formData, {
        ...
        router.push({
            path: '/dropshipping/request/withdrawallist',
        });
