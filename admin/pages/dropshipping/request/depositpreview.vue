                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/dropshipping/request/depositlist">Back to List</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                                                ...
                                                <div class="tab-content" id="custom-tabs-three-tabContent">
                                                    <div class="tab-pane fade active show" id="custom-tabs-three-home"
                                                        ...
                                                        <div class="row mb-3 required">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text"
                                                                    v-model="request.receivable_amount" autofocus
                                                                    class="form-control" />
...
const saveData = () => {
    ...
    axios.post('/deposit/updateDepositRequest', formData, {
        ...
        router.push({
            path: '/dropshipping/request/depositlist',
        });
