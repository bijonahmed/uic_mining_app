                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/dropshipping/product/list">Back to List</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select v-if="subCategories" v-model="selectedsubCategory"
                                                            ...
                                                            <option value="" selected>Select a category</option>
                                                            <option v-for="scategory in subCategories" :key="scategory.id" :value="scategory.id"> {{ scategory.name }} </option>
                                                        </select>
...
const calculatePercentage = () => {
    ...
    insertdata.profit = percetage_amount;
