      ...
      >
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <hr />
            <center><h3>Swap Transaction History</h3></center>
            ...
            <div class="table table-responsive">
              <table
                ...
                <tr>
                  <td width="51"><div align="center">SL</div></td>
                  <td width="202"><div align="left">Frm</div></td>
                  <td width="413"><div align="left">To</div></td>
                  <td width="415">
                    <div align="center">Transaction Date</div>
                  </td>
                </tr>
                <tr v-for="(tran, index) in swap_tran" :key="tran.id">
                    <td><div align="center">{{ index + 1 }}</div></td>
                    <td><div align="left">{{ tran.frm_amount }} {{ tran.wallet_type_frm }}</div></td>
                    <td><div align="left">{{ tran.to_amount }} {{ tran.wallet_type_to }}</div></td>
                    <td><div align="center">{{ tran.created_at }}</div></td>
  </tr>
              </table>
            </div>
            <hr />
