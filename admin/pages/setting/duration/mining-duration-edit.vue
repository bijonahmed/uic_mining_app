<template>
    <title>Edit Mining Duration</title>
    <div>
...
const checkRow = () => {
        ...
        insertdata.id = id;
        axios.get(`/mining/minningDurationrow/${id}`).then(response => {
        insertdata.id = response.data.data.id;
        insertdata.name = response.data.data.name;
        insertdata.mining_category_id = response.data.data.mining_category_id;
        insertdata.packages_name = response.data.data.packages_name;
        insertdata.duration = response.data.data.duration;
        insertdata.prices = response.data.data.prices;
