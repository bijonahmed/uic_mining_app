<template>
    <title>Mining Duration List</title>
    <div>
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/setting/duration/mining-duration-add">New Mining Duration</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <table class="table w-100 table-wrapper">
                                            <thead>
                                                <tr>
                                                    <th class="text-left">Mining Category</th>
                                            ...
                                            <tbody>
                                                <tr v-for="item in productdata" :key="item.id">
                                                    ...
                                                    <td class="text-center">{{ item.packages_name }}</td>
                                                    <td class="text-center">{{ item.duration }}</td>
                                                    <td class="text-center">{{ item.prices }}</td>
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/mining/allMiningDuration`, {
            params: {
                page: page,
                pageSize: pageSize,
...
const edit = (id) => {
    router.push({
        path: '/setting/duration/mining-duration-edit',
        query: {
            parameter: id
        }
    });
