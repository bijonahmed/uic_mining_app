...
class BrandsController extends Controller
{
 ...
 public function allCouminitylist(Request $request)
    {
        //dd($request->all());
        ...
        // dd($selectedFilter);
        $query = Community::orderBy('id', 'desc');
    ...
    public function communityrow($id)
    {
        try {
            $row = Community::find($id);
            $response = [
                'data' => $row,
                'message' => 'success'
            ];
