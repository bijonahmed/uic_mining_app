              ...
              <form @submit.prevent="login()">
                ...
                <div class="form-row-group with-icons">
                  <div class="form-row no-padding">
                    ...
                    <input type="email" name="aaa" class="form-element" placeholder="Username or Email" v-model="email">
                    <span class="text-danger">{{ errors.email }}</span>
                  </div>
                  <div class="form-row no-padding">
                    <i class="fa fa-lock"></i>
                    <input type="password" name="aaa" class="form-element" placeholder="Password" v-model="password">
                ...
                <div class="input_group">
                  <div class='CaptchaWrap'>
                    ...
                    <button type="button" @click="createCaptcha" class="ReloadBtn"><img
                        src="/public/assets/img/refresh.webp" alt=""></button>
                  </div>
                ...
                <div class="form-row">
                  ...
                  <button class="button circle block orange" type="submit" :disabled="loading">
                ...
                <div class="form-row txt-center mt-15">
                  Don't you have an account yet? <nuxt-link data-loader='show' to='/register'>Sign
                    Up</nuxt-link>
                </div>
              </form>
