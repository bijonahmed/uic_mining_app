                        ...
                        <section class="post-sections">
                            ...
                            <div class="post-card">
                                <div class="d-flex align-items-normal">
                                    ...
                                    <div class="ml-10">
                                        <h4 class="coin-name">
                                            {{ entryBy }}<i class="fa fa-bronze"></i>
                                        </h4>
                                        <small class="text-muted"><i class="fa-regular fa-calendar"
                                                style="margin-right: 6px"></i>{{ createdAt }}</small><br />
                                    </div>
                                </div>
                                ...
                                <div v-if="thumnail_img">
                                    <img :src="thumnail_img" alt="Post Image" class="img-fluid" />
                                </div>
...
const thumnail_img = ref("");
const createdAt = ref("");

const fetchData = async (id) => {
    try {
        loading.value = true;
        const response = await axios.get(`/post/postrow/${id}`);
        entryBy.value = response.data.entryBy;
        description_full.value = response.data.description_full;
        thumnail_img.value = response.data.images;
