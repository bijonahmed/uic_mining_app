                      ...
                      <div class="txt-left">
                        ...
                        <div class="form-row-group with-icons">
                          <div class="form-row no-padding">
                            ...
                            <span
                              class="text-danger"
                              v-if="errors.receiver_uic_address"
                        ...
                        <div class="form-row-group with-icons">
                          <div class="form-row no-padding">
                            ...
                            <input
                              type="text"
                              class="form-element"
                              v-model="insertdata.receiver_name"
                              readonly
                            />
                      ...
                      <div class="txt-left" style="width: 100%">
                        ...
                        <div class="form-row-group with-icons">
                          <div class="form-row no-padding">
                            ...
                            <select
                              class="form-element"
                              v-model="insertdata.wallet_type"
                  ...
                  <div class="resources-card-wrapper mt-15">
                    <a class="buy-card mr-10" href="#">
                      <div class="flex-column flex-md-row">
                        ...
                        <h4>Total Sent</h4>
                        <p class="g-text mb-0 font-weight-medium">
                          {{ total_send }}$ Has Been Sent.
                        </p>
                      </div>
                    </a>
                            ...
                            <div class="d-flex align-items-center">
                              ...
                              <div class="ml-10">
                                ...
                                <small class="text-muted"
                                  ><span class=" ">{{ rdata.created_at }}</span></small
                                >
                              </div>
                            </div>
                            <div>
                              <small class="d-block mb-0 txt-red">
                                <span>{{ rdata.amount }} USDT</span>
                              </small>
                            </div>
                          </div>
                        </li>
