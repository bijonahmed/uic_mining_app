                                        ...
                                        <div class="txt-left">
                                            ...
                                            <div class="form-row-group with-icons">
                                                <div class="form-row no-padding">
                                                    ...
                                                    <input type="text" class="form-element" v-model="insertdata.receiver_uic_address" @keyup="handleAddress">
                                                    <span class="text-danger" v-if="errors.receiver_uic_address">{{ errors.receiver_uic_address[0] }}</span>
                                                    <span class="text-danger" v-if="errors.invlaid_uic_address">{{errors.invlaid_uic_address[0] }}</span>
                                        ...
                                        <div class="txt-left">
                                            ...
                                            <div class="form-row-group with-icons">
                                                <div class="form-row no-padding">
                                                    ...
                                                    <span class="text-danger" v-if="errors.receiver_name">{{ errors.receiver_name[0] }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="txt-left">
                                            ...
                                            <div class="form-row-group with-icons">
                                                <div class="form-row no-padding">
                                                    ...
                                                    <span class="text-danger" v-if="errors.password_wrong">{{errors.password_wrong[0] }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="txt-left calc-crr">
                                            ...
                                            <div class="form-row-group with-icons">
                                                <div class="form-row no-padding">
                                                    ...
                                                    <select class="form-element" v-model="insertdata.wallet_type" @change="checkWallet($event.target.value)">
                                                        <option value="">Select</option>
                                                        <option value="1">UIC</option>
                                                        <option value="2">USDT</option>
                                                    </select>
                                                    <span class="text-danger" v-if="errors.wallet_type">{{ errors.wallet_type[0] }}</span>
                                                </div>
                                            </div>
                                        </div>
